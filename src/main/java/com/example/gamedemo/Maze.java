...
public class Maze {
    ...
    private void generateInteriorWalls() {
        int[][][] tmp = {new int[][] {{2, 4, 5, 7, 8, 9}, {2, 7}, {2, 3, 5, 7, 9}, {5, 9}, {1, 3, 4, 5, 6, 7, 9}, {1, 5}, {3, 5, 7, 8, 9}},
        new int[][]{{2, 3, 5, 6, 7, 9}, {0}, {2, 3, 5, 7,8, 9}, {5, 9}, {2, 3, 5, 6, 7, 9}, {3, 5}, {1,3, 5, 7, 8}}};

        double randomDouble = Math.random();
        int k = (int) (randomDouble * 2);
